...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'honma' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'honma' ),
		'repeat-y'  => __( 'Repeat Vertically', 'honma' ),
		'repeat'    => __( 'Repeat All', 'honma' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'honma' ),
		'top center'    => __( 'Top Center', 'honma' ),
		'top right'     => __( 'Top Right', 'honma' ),
		'center left'   => __( 'Middle Left', 'honma' ),
		'center center' => __( 'Middle Center', 'honma' ),
		'center right'  => __( 'Middle Right', 'honma' ),
		'bottom left'   => __( 'Bottom Left', 'honma' ),
		'bottom center' => __( 'Bottom Center', 'honma' ),
		'bottom right'  => __( 'Bottom Right', 'honma')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'honma' ),
		'fixed'  => __( 'Fixed in Place', 'honma')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'honma' ),
		'italic'      => __( 'Italic', 'honma' ),
		'bold'        => __( 'Bold', 'honma' ),
		'bold italic' => __( 'Bold Italic', 'honma' )
		);
