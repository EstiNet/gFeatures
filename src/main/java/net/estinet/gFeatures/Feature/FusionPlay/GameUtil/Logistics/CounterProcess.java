                ...
                if (FusionPlay.currentGame.getSettings().getWaitingSecLeft() <= 0) {
                    ...
                    if (Bukkit.getOnlinePlayers().size() < 2) {
                        ...
                        for (Player p : Bukkit.getOnlinePlayers()) {
                            p.sendTitle(ChatColor.AQUA + "Not enough players! (；一_一)", "", 20, 40, 20);
                        }
                    } else {
                        for (Player p : Bukkit.getOnlinePlayers()) {
                            p.sendTitle(FusionPlay.currentGame.getSettings().getCoolGameName(), ChatColor.GOLD + "" + ChatColor.BOLD + "[" + ChatColor.DARK_AQUA + "" + ChatColor.BOLD + "⚠" + ChatColor.GOLD + "" + ChatColor.BOLD + "] " + ChatColor.WHITE + ChatColor.BOLD + FusionPlay.currentGame.getSettings().getWaitingSecLeft() + ChatColor.GOLD + " " + ChatColor.BOLD + "[" + ChatColor.DARK_AQUA + "" + ChatColor.BOLD + "⚠" + ChatColor.GOLD + "" + ChatColor.BOLD + "] ", 10, 20, 10);
                        }
