                    ...
                    if (event.getName().equalsIgnoreCase(ChatColor.GOLD + "Friends List")) {
                        try {
                            if (Friendship.friendget.get(p.getName()) == null) {
                                ...
                                ClioteSky.getInstance().sendAsync(ClioteSky.stringToBytes("list " + p.getName()), "friends", "Bungee");
                            } else {
                        ...
                        ClioteSky.getInstance().sendAsync(ClioteSky.stringToBytes("requests " + p.getName()), "friends", "Bungee");
                    }
