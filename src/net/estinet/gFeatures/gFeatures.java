...
import net.estinet.gFeatures.API.PlayerStats.*;
...
public class gFeatures {
    ...
    static net.estinet.gFeatures.API.PlayerStats.Setup setup = new net.estinet.gFeatures.API.PlayerStats.Setup();
    ...
    public static boolean getSQLState(){
        if(yamlFile.get("Config.MySQL.State").equals("true")){
            return true;
        }
        else{
            return false;
