...
import net.estinet.gFeatures.Feature.Bedwars.Disable;
import net.estinet.gFeatures.Feature.Bedwars.Enable;
import net.estinet.gFeatures.Feature.Bedwars.EventBase.CommandHub;
import net.estinet.gFeatures.Feature.Bedwars.EventHub;
...
public class Bedwars extends gFeature implements Events{

    EventHub eh = new EventHub();
    CommandHub ch = new CommandHub();

    public Bedwars(String featurename, String d) {
        super(featurename, d);
    }
    @Override
    public void enable(){
